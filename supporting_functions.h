...
void Configure_Accel_GPIO			(void); // defined in GPIOConfig.c
int16_t* Accelerometer_Read		(void); // defined in AccelerometerRead.c
void Configure_Accel					(void); // defined in GPIOConfig.c

//void Set_Interrupt						(void);

//a flag for the accelerometer
//int Accel_Flag = 0;
